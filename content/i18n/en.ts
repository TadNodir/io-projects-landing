...
export const en: Dictionary = {
  ...
  ui: {
    navPricing: "Pricing",
    navFaq: "FAQ",
    navCta: "Get my free preview",
    navHomeAria: "IO Projects — home",
    ...
    heroTrustAria: "Trust signals",

    problemAria: "The problem",
    problemReality: "The reality",
    scroll: "scroll",

    solutionSubhead: "Four reasons your clients will trust you on sight.",

    howItWorksSubhead: "No tech knowledge needed. Ever.",
    stepOf: "Step {n} of {total}",

    pricingGetStarted: "Get started",
    pricingWhatsIncluded: "What's included",

    faqMoreAnswers: "More answers",
    faqAdditionalAria: "Additional questions",

    footerAboutHeading: "About IO Projects",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes — you own both outright. We set them up in your name; they're yours to keep.",
      },
      {
        q: "Can I update the site myself?",
        a: "Yes — and if you'd rather not, just send us the change and we'll handle it. Either way, you're never stuck.",
      },
      {
        q: "I already have a website. Can you take over?",
        a: "Yes — we migrate everything from your existing site, with no technical hassle for you.",
      },
      {
        q: "Do I need any technical knowledge?",
        a: "None at all. We handle every technical aspect from setup to ongoing maintenance.",
      },
      {
        q: "What's the difference between SEO and GEO?",
        a: "SEO (Search Engine Optimisation) gets you found on Google. GEO (Generative Engine Optimisation) means AI assistants like ChatGPT and Perplexity recommend you by name when someone asks for the best beauty specialist in town.",
      },
      {
        q: "What technology do you build on?",
        a: "We use modern, fast, standards-based web technology — no page-builder templates. Your site will be fast, secure, and built to last.",
      },
    ],
  },
  ...
  footer: {
    ...
    aboutHeading: "About IO Projects",
    about:
